...
import { headerLogoURL } from "@/config/Constants"
          ...
          <Grid container spacing={3}>
            ...
            <Grid item md={4}>
              <ul style={{ color: "white", listStyle: "none" }}>
                ...
                <li style={listStyle}>
                  <RLink href="/guide/about" style={rLinkStyle}>
                    About
                  </RLink>
                </li>
                <li style={listStyle}>
                  <RLink href="/guide/community-guideline" style={rLinkStyle}>
                    ガイドライン
                  </RLink>
                </li>
                <li style={listStyle}>
                  <RLink href="/guide/privacy" style={rLinkStyle}>
                    プライバシーポリシー
                  </RLink>
                </li>
                <li style={listStyle}>
                  <RLink href="/guide/feedback" style={rLinkStyle}>
                    ご意見
                  </RLink>
                </li>
                <li style={listStyle}>
                  <RLink href="/users/admin/posts/154" style={rLinkStyle}>
                    ヘルプ
                  </RLink>
                </li>
              </ul>
            ...
            <Grid item md={4}>
              <ul style={{ color: "white", listStyle: "none" }}>
                ...
                <li style={listStyle}>
                  <RLink href="/product/contact-me" style={rLinkStyle}>
                    Contact Me
                  </RLink>
                </li>
                <li style={listStyle}>
